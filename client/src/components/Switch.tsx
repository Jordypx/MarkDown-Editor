...
const Switch = () => {
  ...
  return (
    <div className="flex items-center">
      <svg  width="16.46" height="16" xmlns="http://www.w3.org/2000/svg">
        <path className="duration-300 ease-in-out"
      ...
      <label
        ...
        className='bg-custom-grey-400 cursor-pointer relative h-6 w-12 rounded-full block before:content-["_"] before:block before:w-3 before:h-3 before:bg-custom-white-100 before:rounded-full before:absolute before:top-[calc(50%-(0.75rem/2))] before:left-2 before:right-2 before:ease-in-out before:duration-300 peer-checked:before:left-[calc(100%-1.15rem)] peer-checked:before:ease-in-out peer-checked:before:duration-300 mx-2'
      ></label>
